 ...
 */ !(function () {
    ...
    return (
      ...
      (o = [
        ...
        },
        {
          ...
          value: function (t, i, o) {
            t &&
              (i = s.removeArrayEmpty(i.split(" "))).forEach(function (i) {
  ...
  var v = { 13: "onEnterPress", 38: "onUpArrowPress", 40: "onDownArrowPress" },
    f = ["multiple", "disabled", "required", "autofocus"],
    y = {
      id: "id",
      value: "value",
      multiple: "multiple",
        ...
        (o = [
          {
            ...
            value: function (t) {
              ...
              if (i) {
                ...
                if (
                  "string" != typeof i ||
                  0 !== (i = document.querySelectorAll(i)).length
                ) {
          ...
          },
          {
            ...
            value: function (e) {
              ...
              i.forEach(function (e) {
                var t = e.value;
                o.push({ label: e.innerHTML, value: t }),
                  e.disabled && s.push(t),
                  e.selected && n.push(t);
              });
              var a = document.createElement("div");
              l.setAttrFromEle(t, a, Object.keys(y), f),
        ...
        (i = [
          {
            ...
            value: function () {
              if (this.$ele) {
                ...
                var o = '<div class="vscomp-ele-wrapper '
                  .concat(
                    e,
            ...
            value: function (e) {
              ...
              if (i) {
                ...
                return (
                  ...
                  (s.innerHTML = o),
                  i.appendChild(s),
                  l.addClass(s, "vscomp-dropbox-wrapper ".concat(t)),
                  ""
                );
              }
          ...
          },
          {
            ...
            value: function () {
              var e,
                ...
                l = this.disableOptionGroupCheckbox,
                p = "function" == typeof r;
              if (
              ...
              o.forEach(function (o) {
                var u,
                  h = "vscomp-option",
                  c = t.getTooltipAttrText("", !0),
                  d = s,
                  v = "",
                  f = "",
                  y = "";
                o.isFocused && (h += " focused"),
                  o.isDisabled && (h += " disabled"),
                  o.isGroupTitle && ((h += " group-title"), l && (d = "")),
                  o.isSelected && (h += " selected"),
                  o.isGroupOption &&
                  ((h += " group-option"),
                    (y = 'data-group-index="'.concat(o.groupIndex, '"'))),
                  (u = p ? r(o) : o.label),
                  o.description &&
                  (f = '<div class="vscomp-option-description" '
                    .concat(c, ">")
                  ...
                  o.isCurrentNew
                    ...
                    : a &&
                    !o.isGroupTitle &&
                    (u = u.replace(e, "<mark>$1</mark>")),
                  (i += '<div class="'
                    .concat(h, '" data-value="')
                    .concat(o.value, '" data-index="')
                    .concat(o.index, '" data-visible-index="')
          ...
          },
          {
            ...
            value: function () {
              ...
              (!this.allowNewOption ||
                ...
                l.toggleClass(this.$allWrappers, "has-no-search-results", i),
                l.toggleClass(this.$allWrappers, "has-no-options", t),
                this.setOptionAttr(),
          ...
          },
          {
            ...
            value: function (e) {
              ...
              (this.$ele = e.ele),
                ...
                (this.enableSecureText = t(e.enableSecureText)),
                (this.setValueAsArray = t(e.setValueAsArray)),
                (this.disableValidation = t(e.disableValidation)),
                (this.initialDisabled = t(e.disabled)),
                (this.required = t(e.required)),
                (this.autofocus = t(e.autofocus)),
                ...
                (this.name = this.secureText(e.name)),
            ...
            value: function (e, t) {
              ...
              e &&
                ...
                this.options.forEach(function (e) {
                  !0 !== i[e.value] || e.isGroupTitle
                    ? (e.isSelected = !1)
                    : ((e.isSelected = !0), o.push(e.value));
                }),
                this.multiple || (o = o[0]),
                this.beforeValueSet(),
                this.setValue(o, { disableEvent: t }),
                this.afterValueSet();
            },
          },
          {
            ...
            value: function (e) {
              ...
              this.disabledOptions.forEach(function (e) {
                ...
                e.forEach(function e(s) {
                  ...
                  if (
                    (i && (m.isDisabled = !0 === f[y]),
                      s.isGroupOption &&
                      ((m.isGroupOption = !0), (m.groupIndex = s.groupIndex)),
                      l && (m.description = u(p(s[a]))),
                      t.push(m),
                      d++,
                      g)
                  ) {
              ...
              (b.options = t),
                (b.length = y),
                (this.options = t),
                (this.visibleOptionsCount = y),
                (this.lastOptionIndex = y - 1),
                (this.newValues = []),
                (this.hasOptionGroup = v),
          ...
          },
          {
            ...
            value: function () {
              var e = u(this.sortedOptions),
                ...
                s = i + t - 1,
                n = 0;
              o && ((o.visibleIndex = n), n++),
                (e = e.filter(function (e) {
                  var t = !1;
                  return (
                    e.isVisible &&
                    !e.isCurrentNew &&
                    ((t = n >= i && n <= s), (e.visibleIndex = n), n++),
                    t
                  );
                })),
                o && (e = [o].concat(u(e))),
            ...
            value: function (e) {
              ...
              (this.$ele.value = r),
                ...
                this.setValueAsArray && this.multiple && r && r.length
                  ? (this.$hiddenInput.value = JSON.stringify(r))
                  : (this.$hiddenInput.value = r),
                a || this.validate(),
                o || l.dispatchEvent(this.$ele, "change", !0);
            },
          },
          {
            key: "setValueText",
                ...
                if ("" === m) a.innerHTML = this.placeholder;
                  ...
                  if (
                    ...
                    if (
                      ...
                      (a.innerHTML = t.join("")),
                        (this.$valueTags =
                          a.querySelectorAll(".vscomp-value-tag")),
          ...
          },
          {
            ...
            value: function () {
              ...
              this.showAsPopup ||
                (this.dropboxWidth && (e.width = this.dropboxWidth)),
                l.setStyles(this.$dropboxContainer, e);
            },
          },
          {
            key: "setOptionAttr",
            value: function () {
              ...
              e &&
                ...
                e.forEach(function (e) {
                  var a = t[s(e, "index")];
                  o(e, "height", i), n(e, "value", a.value);
                });
            },
          },
          {
            ...
            value: function (e) {
              (this.isSilentClose = e),
                this.keepAlwaysOpen
                  ? this.removeOptionFocus()
                  : (e
                    ? l.setStyle(this.$dropboxContainer, "display", "")
            ...
            value: function (e, t) {
              ...
              if (t) i = t;
                ...
                (i = this.$dropboxContainer.querySelector(
                  ...
                  (l.hasClass(i, "disabled") || l.hasClass(i, "group-title")) &&
                  (i = this.getSibling(i, "next"));
              }
              i &&
                i !== o &&
                (o && l.removeClass(o, "focused"),
                  l.addClass(i, "focused"),
                  this.toggleFocusedProp(l.getData(i, "index"), !0),
                  this.moveFocusedOptionToView(i));
            },
          },
          {
              ...
              if (e) {
                ...
                if (
                  ...
                  if (this.multiple)
                    ...
                    h && l.toggleClass(h, "selected", !1), this.closeDropbox();
                  }
                ...
                n.forEach(function (e) {
                  ...
                  this.options.forEach(function (e) {
                    if (!e.isDisabled && e.groupIndex === o) {
                      var i = e.value;
                      !t || (a && !e.isVisible)
                        ? ((e.isSelected = !1), r[i] && p(n, i))
                        : ((e.isSelected = !0), r[i] || n.push(i));
                    }
                  }),
          ...
          },
          {
            ...
            value: function () {
              ...
              this.options.forEach(function (e) {
                ...
                this.afterValueSet(),
                e && l.removeClass(this.$allWrappers, "has-error"),
          ...
          },
          {
            ...
            value: function (e, t, i, o) {
              var s = e.label.toLowerCase(),
                ...
                r = -1 !== s.indexOf(t);
              return (
                e.isGroupTitle && (r = o[e.index]),
                a && !r && (r = -1 !== a.indexOf(t)),
                n && !r && (r = -1 !== n.toLowerCase().indexOf(t)),
                (e.isVisible = r),
                i || (i = s === t),
                { isVisible: r, hasExactOption: i }
              );
            },
          },
          {
          ...
          },
          {
            ...
            value: function () {
              ...
              var e = !1;
              return (
                this.required && s.isEmpty(this.selectedValues) && (e = !0),
                l.toggleClass(this.$allWrappers, "has-error", e),
                !e
              );
            },
          },
  ...
  document.addEventListener("reset", b.onFormReset),
    document.addEventListener("submit", b.onFormSubmit),
    window.addEventListener("resize", b.onResizeMethod),
    (window.VirtualSelect = b),
          ...
          (t = [
            ...
            },
            {
              ...
              value: function () {
                ...
                F && ((P += F), (I -= F), (M += F), (H -= F)),
                  "auto" === E &&
                  (E = i.getMoreVisibleSides(this.$triggerEle).vertical);
                var N = {
                  top: { top: C - h - D, left: k + $ },
                  bottom: { top: C + b + D, left: k + $ },
                  right: { top: C + T, left: k + y + D },
                  left: { top: C + T, left: k - u - D },
                },
                  W = N[E];
                if (
                  ((C = W.top),
                ...
                "top" === E
                  ...
                  : "right" === E
                    ...
                    : "left" === E
                      ? ((e = C), (t = k + V))
                      : ((e = C - V), (t = k));
                var G = "translate3d(".concat(t, "px, ").concat(e, "px, 0)");
                if (
                  (i.setStyle(this.$popperEle, "transform", G),
                    ...
                    i.addClass(this.$popperEle, "position-".concat(E)),
                    this.hasArrow)
                ) {
                  var L = 0,
                    R = 0,
                ...
                clearTimeout(this.exitDelayTimeout),
                  ...
                  (this.enterDelayTimeout = setTimeout(function () {
                    ...
                    i.show(e.$popperEle, "inline-flex"),
                      ...
                      i.setStyle(e.$popperEle, "transitionDuration", a + "ms"),
